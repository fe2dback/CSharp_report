...
namespace project_H
{
    class check_draw
    {
        ...
        private static bool Dead = false; //죽음유무
        private static bool multi = false;
        public char[] char_A = new char[word.Length];//텍스트 스펠링쪼개기
        public List<char> char_L = new List<char>();//스펠링 리스트
        public List<char> char_count = new List<char>();//정답개수 리스트         
